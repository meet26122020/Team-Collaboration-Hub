...
app.get("/", (req, res) => {
    res.send(
        "<center><h1>Team Collaboration Hub</h1><br>Get Recipe Api <a href=https://github.com/Devanshiballar/Team_Collaboration_Hub.git target=_blank>Repository :Team Collaboration Hub</a></center>"
    );
});
